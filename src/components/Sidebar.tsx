...
const Sidebar = () => {
    return (
        ...
        <div className="min-h-25000 bg-yellow-100 z-50 border-r text-black w-110 md:flex flex-col font-bold hidden absolute top-25 left-0">
          
            <div className="flex flex-col text-2xl text-center justify-center w-100 sticky top-25 left-0">
